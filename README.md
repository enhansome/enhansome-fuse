...
This list is currently unmaintained, and we are looking for a new maintainer. See [here](https://github.com/fuse-compound/awesome-fuse/issues/57) ⭐ 364 | 🐛 0 | 📅 2019-02-25 for details if you're interested.
...
* [Hikr](https://github.com/fusetools/hikr) ⭐ 42 | 🐛 3 | 🌐 JavaScript | 📅 2018-03-09 - An example app case to accompany [Fuse's end-to-end tutorial](https://www.fusetools.com/docs/tutorial/tutorial).
* [Fuse PM](https://github.com/bolav/fusepm) ⭐ 32 | 🐛 3 | 🌐 JavaScript | 📅 2017-03-28 - A Fusetools package manager.
* [Haxe](https://github.com/elsassph/fusetools-haxe) ⭐ 31 | 🐛 1 | 🌐 Haxe | 📅 2015-10-19 - Haxe compiler for Fuse tools.
* [Fuse Tags with Firebase](https://github.com/LuisRodriguezLD/Fuse-Tags-with-Firebase) ⭐ 14 | 🐛 0 | 📅 2016-06-27 - Simple Tags app. Adds and retrieves tags from Firebase.
* [Motion](https://github.com/AlexGustafsson/fuse-motion) ⚠️ Archived - iOS accelerometer, gyroscope, magnetometer readings and more for Fuse.
* [UnityAds Sample](https://github.com/englekk/Fusetools_UnityAdsSample) ⭐ 9 | 🐛 0 | 🌐 Objective-C | 📅 2016-11-10 - Simple example of integration UnityAds with Fuse.
* [Fuse Pokedex](https://github.com/franzsilva/FusePokeDex) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2017-10-25 - A Pokedex created using Fuse.
* [Syncano](https://github.com/Syncano/syncano-fuse-example) ⭐ 5 | 🐛 1 | 🌐 JavaScript | 📅 2016-07-13 - Simple example of integration Syncano with Fuse.
* [fuse.QrScanner](https://github.com/glenfordwilliams/fuse.QrScanner) ⭐ 3 | 🐛 0 | 🌐 Uno | 📅 2017-02-16 - A small library for scanning QrCode.
* [Fuse Input Validation](https://github.com/mokko-lab/fuse-input-validation) ⭐ 1 | 🐛 0 | 📅 2017-01-24 - Reusable and highly functional input validation methods in Fuse components
* [Fuse Review](https://github.com/LuisRodriguezLD/Fuse-RequestReview) ⭐ 1 | 🐛 0 | 🌐 Uno | 📅 2018-02-06 - Get reviews from your users without making them leave the app.
* [Fuse Taptic-Feedback](https://github.com/LuisRodriguezLD/Fuse-TapticFeedback) ⭐ 1 | 🐛 0 | 🌐 Uno | 📅 2017-10-18 - Get access to the iPhone 7's taptic engine.
* [FormulaFuse](https://github.com/sanderdan/FormulaFuse) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2016-09-13 - Formula 1 Fuse application.
